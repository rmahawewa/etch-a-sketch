...
h1.setAttribute("style", "color:red; text-align:left; font-family: arial helvetica sans-serif; border: 50px;");

var body = document.querySelector(".body");
function adjustWidth(mediawidth){
    if(mediawidth.matches){
        body.setAttribute("style", "display: flex; justify-content: space-evenly; font-family: arial helvetica sans-serif;");
    }else{
        body.setAttribute("style", "display: flex; flex-direction: column; font-family: arial helvetica sans-serif;");

    }
}

var mediawidth = window.matchMedia("(min-width: 40em)");
...
reset.setAttribute("style", "background: orange; color: black; font-weight: bold; padding: 10px; border: 4px solid black; width: 5rem");

var container = document.querySelector(".container");
container.setAttribute("style", "width: 960px; height: 960px; display: flex; flex-direction: column; border: none; margin-top: 1rem;");
